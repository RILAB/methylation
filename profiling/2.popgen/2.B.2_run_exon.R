...
# 4  sd=c(1E-3,1E-3,1E-4)
# 5  sd=c(1E-4,1E-4,1E-3)
res <- MCMCBC(my_sfs=sfs$Freq, sites=649360, ngen=100000, rates=c(1E6,1E6,1E5), sd=c(1E-4,1E-4,1E-3),
              conditional=FALSE, k=0:40, Ne=150000, verbose=TRUE)
tab <- accept_rate(res)

#####
save(list="res", file="largedata/res_k40_exon4.RData")
