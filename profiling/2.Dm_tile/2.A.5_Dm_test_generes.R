...
#### genes
res1 <- get_Dm(pwd="largedata/Dm/gene_CG/cg_input")
write.table(res1, "cache/res_gene_cg.csv", sep=",", row.names=FALSE, quote=FALSE)

res2 <- get_Dm(pwd="largedata/Dm/gene_CHG/chg_input")
write.table(res2, "cache/res_gene_chg.csv", sep=",", row.names=FALSE, quote=FALSE)

res3 <- get_Dm(pwd="largedata/Dm/gene_CHH/chh_input")
write.table(res3, "cache/res_gene_chh.csv", sep=",", row.names=FALSE, quote=FALSE)
